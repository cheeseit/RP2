...
The vertices are evenly distributed between the processes.
...
The paper by Suzumura \cite also gives an estimate of the amount of communication in the \texttt{graph500\_mpi\_simple} . The formula is:
\begin{equation}
